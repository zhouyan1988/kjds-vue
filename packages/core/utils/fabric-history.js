...
fabric.Canvas.prototype._historyInit = function () {
  ...
  this.extraProps = ['id', 'gradientAngle', 'selectable', 'hasControls', 'linkData', 'editable', 'extensionType', 'extension'];
...
fabric.Canvas.prototype._historySaveAction = function (e) {
  ...
  if (!e || (e.target && !e.target.excludeFromExport)) {
    ...
    !this.isLatestHistoryState && (this.isLatestHistoryState = true) && this.historyIndex < this.historyMaxLength && this.historyIndex++;
