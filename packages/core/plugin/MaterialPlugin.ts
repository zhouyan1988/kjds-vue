...
type IPlugin = Pick<MaterialPlugin, 'getTemplTypeList' | 'getTemplList' | 'getMaterialTypeList' | 'getMaterialList' | 'getSizeList'>;
...
class MaterialPlugin implements IPluginTempl {
  ...
  static apis = ['getTemplTypeList', 'getTemplList', 'getMaterialTypeList', 'getMaterialList', 'getSizeList'];
