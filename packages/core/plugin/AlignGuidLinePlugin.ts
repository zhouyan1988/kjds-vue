      ...
      for (let i = canvasObjects.length; i--; ) {
        ...
        if (isInRange(objectLeft - objectWidth / 2, activeObjectLeft - activeObjectWidth / 2)) {
          ...
          if (leftRight.get(e.transform.corner)) {
            ...
            activeObject.set(
              'scaleX',
              ((activeLeft - (objectLeft - objectWidth / 2) + activeWidth) * activeObject.scaleX) / activeObject.getScaledWidth()
            );
            break;
          }
        }
        ...
        if (isInRange(objectLeft + objectWidth / 2, activeObjectLeft + activeObjectWidth / 2)) {
          ...
          if (Right.get(e.transform.corner)) {
            activeObject.set(
              'scaleX',
              ((objectLeft + objectWidth / 2 - (activeLeft + activeWidth) + activeWidth) * activeObject.scaleX) / activeObject.getScaledWidth()
            );
            break;
          }
        }
        ...
        if (isInRange(objectTop - objectHeight / 2, activeObjectTop - activeObjectHeight / 2)) {
          ...
          if (bottomRight.get(e.transform.corner)) {
            ...
            activeObject.set(
              'scaleY',
              ((activeTop + activeHeight - (objectTop - objectHeight / 2)) * activeObject.scaleY) / activeObject.getScaledHeight()
            );
            break;
          }
        }
        ...
        if (isInRange(objectTop + objectHeight / 2, activeObjectTop + activeObjectHeight / 2)) {
          ...
          if (bottom.get(e.transform.corner)) {
            activeObject.set(
              'scaleY',
              ((objectTop + objectHeight / 2 - (activeTop + activeHeight) + activeHeight) * activeObject.scaleY) / activeObject.getScaledHeight()
            );
            break;
          }
        }
        ...
        if (isInRange(objectLeft - objectWidth / 2, activeObjectLeft + activeObjectWidth / 2)) {
          ...
          if (right.get(e.transform.corner)) {
            activeObject.set('scaleX', ((objectLeft - objectWidth / 2 - activeObject.left) * activeObject.scaleX) / activeObject.getScaledWidth());
            break;
          }
        }
        //右边线和左边线
        if (isInRange(objectLeft + objectWidth / 2, activeObjectLeft - activeObjectWidth / 2)) {
          ...
          if (leftRight.get(e.transform.corner)) {
            ...
            activeObject.set(
              'scaleX',
              ((activeLeft + activeWidth - (objectLeft + objectWidth / 2)) * activeObject.scaleX) / activeObject.getScaledWidth()
            );
            break;
          }
        }
        ...
        if (isInRange(objectTop - objectHeight / 2, activeObjectTop + activeObjectHeight / 2)) {
          ...
          if (bottom.get(e.transform.corner)) {
            activeObject.set('scaleY', ((objectTop - objectHeight / 2 - activeObject.top) * activeObject.scaleY) / activeObject.getScaledHeight());
            break;
          }
        }
        //下边线和上变线
