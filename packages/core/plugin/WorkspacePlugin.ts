...
type IPlugin = Pick<WorkspacePlugin, 'big' | 'small' | 'auto' | 'one' | 'setSize' | 'getWorkspase' | 'setWorkspaseBg' | 'setCenterFromObject'>;
...
class WorkspacePlugin implements IPluginTempl {
  ...
  static apis = ['big', 'small', 'auto', 'one', 'setSize', 'getWorkspase', 'setWorkspaseBg', 'setCenterFromObject'];
