...
function intervalControl() {
  ...
  function renderIconHoz(ctx: CanvasRenderingContext2D, left: number, top: number, styleOverride: any, fabricObject: fabric.Object) {
...
function peakControl() {
  ...
  function renderIconEdge(ctx: CanvasRenderingContext2D, left: number, top: number, styleOverride: any, fabricObject: fabric.Object) {
...
function rotationControl() {
  const img = document.createElement('img');
  img.src = rotateImg;
  function renderIconRotate(ctx: CanvasRenderingContext2D, left: number, top: number, styleOverride: any, fabricObject: fabric.Object) {
...
class ControlsPlugin implements IPluginTempl {
  ...
  init() {
    ...
    //   if (type === EditorTypeEnum.Options) {
    //     // 设置透明色，隐藏控制条
    //     fabric.Object.prototype.set({
    //       transparentCorners: false,
