...
// 注册 ECharts 必要的组件
echartsCore.use([PieChart, GaugeChart, TitleComponent, TooltipComponent, LegendComponent, ToolboxComponent, GridComponent, CanvasRenderer]);
...
const getList = async () => {
  ...
  const commandstatsIntance = echartsCore.init(commandstats.value, 'macarons');
  ...
  const usedmemoryInstance = echartsCore.init(usedmemory.value, 'macarons');
