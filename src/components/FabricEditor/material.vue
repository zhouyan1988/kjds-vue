...
<template>
  <div>
    <!-- 搜索组件 -->
    <searchType ref="selectTypeRef" :type-list-api="getMaterialTypes" @change="searchChange"></searchType>

    <!-- 分类列表 -->
    <typeList
      v-show="!filters.material_type.$contains && !filters.name.$contains"
      :type-api="getMaterialTypes"
      :type-list-api="getMaterialsByType"
      type-key="material_type"
