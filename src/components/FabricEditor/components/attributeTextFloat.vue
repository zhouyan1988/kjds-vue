  ...
  <div v-if="isOne && isMatchType" class="attr-item-box">
    <div class="flex-view">
      <div class="flex-item">
        ...
        <div class="content">
          <Select v-model="baseAttr.verticalAlign" @on-change="(value) => changeCommon('verticalAlign', value)">
...
<script name="Price" setup lang="ts">
...
const matchType = [EditorTypeEnum.IText, EditorTypeEnum.TextBox, EditorTypeEnum.Text];
