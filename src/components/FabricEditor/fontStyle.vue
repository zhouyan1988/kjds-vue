...
<template>
  <div>
    <!-- 搜索组件 -->
    <searchType ref="selectTypeRef" :type-list-api="getFontStyleTypes" @change="searchChange"></searchType>

    <!-- 分类列表 -->
    <typeList
      v-show="!filters.font_style_type.$contains && !filters.name.$contains"
      :type-api="getFontStyleTypes"
      :type-list-api="getFontStyleListByType"
      type-key="font_style_type"
