...
<template>
  <div v-if="route?.query?.id" style="display: inline-block">
    <Input v-model="fileName" placeholder="请输入文件名称" style="width: 190px" size="small" :loading="loading" @on-change="changeFileName" />
    <Button type="text" :loading="loading" @click="saveTempl">
