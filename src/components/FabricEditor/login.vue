        ...
        <TabPane :label="$t('login.login')">
          <Form ref="loginForm" :model="formInline" :rules="ruleInline" class="form-box">
            <FormItem prop="identifier">
              <Input v-model="formInline.identifier" type="text" :placeholder="$t('login.identifier')">
                <template #prepend>
            ...
            <FormItem prop="password">
              <Input v-model="formInline.password" type="password" :placeholder="$t('login.password')">
                <template #prepend>
        ...
        <TabPane :label="$t('login.register')">
          <Form ref="registerForm" :model="registerFormInline" :rules="registerRuleInline" class="form-box">
            <FormItem prop="username">
              <Input v-model="registerFormInline.username" type="text" :placeholder="$t('login.username')">
                <template #prepend>
                  <Icon type="ios-person-outline"></Icon>
                </template>
              </Input>
            ...
            <FormItem prop="email">
              <Input v-model="registerFormInline.email" type="text" :placeholder="$t('login.email')">
                <template #prepend>
            ...
            <FormItem prop="password">
              <Input v-model="registerFormInline.password" type="password" :placeholder="$t('login.password')">
                <template #prepend>
                  <Icon type="ios-lock-outline"></Icon>
                </template>
              </Input>
