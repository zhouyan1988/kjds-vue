...
export const constantRoutes: RouteRecordRaw[] = [
    ...
    children: [
      {
        ...
        name: 'CampaignsIndex',
        meta: { title: '组合模版', icon: 'theme' }
      }
    ]
  },
  {
    path: '/campaigns/add',
    component: () => import('@/views/campaigns/add.vue'),
    name: 'CampaignsAdd',
    meta: { title: '新增组合' },
    hidden: true
  },
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/artworks/index.vue'),
        name: 'ArtworksIndex',
        meta: { title: '设计模版', icon: 'color' }
      }
    ]
  },
  {
    path: '/artworks/details',
    component: () => import('@/views/artworks/details.vue'),
    ...
    children: [
      {
        ...
        name: 'MaterialIndex',
        meta: { title: '素材库', icon: 'documentation' }
      },
      {
        path: 'imageList',
        component: () => import('@/views/material/imageList.vue'),
        name: 'MaterialImageList',
        meta: { title: '图片列表', activeMenu: '/material/index' },
        hidden: true
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/kjds/fonts/index.vue'),
        name: 'FontsIndex',
        meta: { title: '字体管理', icon: 'dashboard' }
      }
    ]
  },
  // {
  //   path: '/system',
  //   component: Layout,
  //   meta: { title: 'OSS管理', icon: 'dashboard' },
  //   children: [
  //     {
  //       path: 'oss',
  //       children: [
